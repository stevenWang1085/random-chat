        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/random">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/friend_check" tabindex="-1" >
                ...
                <ul class="navbar-nav dropdown-menu-end mb-2 mb-md-0">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <li><a  @click="logout" class="dropdown-item" href="javascript:void(0);">
