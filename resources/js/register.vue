...
<!--                                <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="#!">Forgot password?</a></p>-->
                                ...
                                <button @click="signUp"  v-on:keyup.enter="signUp" class="btn btn-outline-light btn-lg px-5" type="submit">註冊</button>
...
<!--                                    <a href="#!" class="text-white"><i class="fab fa-google fa-lg"></i></a>-->
                            ...
                            <div>
                                <p class="mb-0">已經有帳號了？ <a href="javascript:void(0);" @click="goToLogin" class="text-white-50 fw-bold">登入</a></p>
                            </div>
